export default function Social() {
  const socials = [
    {
      name: "GitHub",
      username: "@Divyeshram07",
      description: "Open source projects & contributions",
      link: "https://github.com/Divyeshram07",
    ...
    },
    {
      ...
      link: "https://www.linkedin.com/in/divyeshram28/",
    ...
    {
      name: "Instagram",
      username: "@divyesh._.ram",
      description: "Personal updates & highlights",
      link: "https://www.instagram.com/divyesh._.ram/",
    ...
    {
      name: "Twitter (X)",
      username: "@divyesh_ram_28",
      description: "Tech thoughts & insights",
      link: "https://x.com/divyesh_ram_28",
      color: "hover:bg-gray-100",
      svg: (
